...
<a href="https://github.com/Excelsior92/CodSoftPproject3"><strong>➥ Live Demo</strong></a>
...
```bash
sudo git clone https://github.com/Excelsior92/CodSoftPproject3
```

Windows:

```bash
git clone https://github.com/Excelsior92/CodSoftPproject3
```
